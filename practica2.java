...
Practica 2: Proyeccion perspectiva
*/
...
public class practica2 extends JFrame{
    ...
    //perspectiva
    public int xh = 100, yh = 170, zh = 300;
    ...
    public practica2(){
        ...
        setTitle("Practica2 Proyeccion Perspectiva");
        setResizable(false);
        setSize(500, 500);
        setVisible(true);
    ...
    //Funcion para calcular x2 y y2
     public int[] calcular2D(int x1, int y1, int z1){
        ...
        x2 = xh - (((x1 - xh) * zh) / (z1 - zh));
        y2 = yh - (((y1 - yh) * zh) / (z1 - zh));
